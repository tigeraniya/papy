    ...
    def __init__(self, entity =None):
        ...
        try:
            if entity is not None:
                dict.__init__(self, {entity:Node()})
        except Exception, e:
            raise e
...
class Graph(dict):
    ...
    def dfs(self, node, bucket =None, order ='append'):
        """ Recursive depth first search.
            By default (order = 'append') this returns the nodes in the
            reverse postorder. To change this into the preorder
            use a collections.deque bucket and order 'appendleft'.
        """

...
is related to mathematic evaluations.

If a function accepts multiple arguments two flavours of wrappers are provided:

  #. simple wrapper: math.X(arg1, arg2) should be called from
     papy.workers.maths.X as X([arg1], arg2)

  #. star wrapper: math.X(arg1, arg2) should be called from
     papy.workers.maths.Xstar ars Xstar(arg)

In other words 1. should be used to construct workers which accept arguments at

...
conf = PDBConfiguration('3bw1.pdb')
molecules = conf.createPeptideChains()
...
# "Production" run  
trajectory = Trajectory(universe, "3bw1.nc", "w", "A simple test case")  
...
print trajectoryInfo('3bw1.nc')  
  
# Reopen trajectory file  
trajectory = Trajectory(universe, "3bw1.nc", "r")  
